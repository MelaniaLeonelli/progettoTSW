	...
	<section class="py-5">
		<div class="container px-4 px-lg-5 mt-5">
			<div
					...
					<div class="card h-100">
						...
						<div class="card-body p-4">
							<div class="text-center">
								<!-- Product name-->
								<h5 class="fw-bolder"><%=p.get(i).getMarca() + " " + p.get(i).getNome()%></h5>
								<!-- Product price-->
								$<%=p.get(i).getCosto()%>
							</div>
						</div>
						...
						<div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
							<div class="text-center">
								<a class="btn btn-outline-dark mt-auto"
									href="ProductPageServlet?pcode=<%=p.get(i).getCodprodotto()%>">Visualizza
									prodotto</a>
							</div>
						</div>
					</div>
				...
				<%ArrayList<Prodotto> pb = (ArrayList<Prodotto>) request.getAttribute("brand");
	  			i = 0;
	  			while(i < pb.size()){%>
				<div class="col mb-5">
					<div class="card h-100">
						...
						<div class="card-body p-4">
							<div class="text-center">
								<!-- Product name-->
								<h5 class="fw-bolder"><%=pb.get(i).getMarca() + " " + pb.get(i).getNome()%></h5>
								<!-- Product price-->
								$<%=pb.get(i).getCosto()%>
							</div>
						</div>
						...
						<div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
							<div class="text-center">
								<a class="btn btn-outline-dark mt-auto"
									href="ProductPageServlet?pcode=<%=pb.get(i).getCodprodotto()%>">Visualizza
									prodotto</a>
							</div>
						</div>
					</div>
